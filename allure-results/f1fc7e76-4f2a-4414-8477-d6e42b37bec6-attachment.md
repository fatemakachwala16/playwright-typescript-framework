...
- Name: myInfo\myInfo.spec.ts >> My Info Page Tests >> Verify first name is updated successfully @regression
- Location: tests\myInfo\myInfo.spec.ts:16:7
...
Locator:  locator('input[placeholder="First Name"]')
Expected: "Furman"
Received: "robert12345"
Timeout:  5000ms

Call log:
  - Expect "toHaveValue" with timeout 5000ms
  - waiting for locator('input[placeholder="First Name"]')
    13 × locator resolved to <input name="firstName" data-v-1f99f73c="" placeholder="First Name" class="oxd-input oxd-input--focus orangehrm-firstname"/>
       - unexpected value "robert12345"

```

```yaml
- textbox "First Name": robert12345
```
