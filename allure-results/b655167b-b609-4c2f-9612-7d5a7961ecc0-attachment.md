...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Employee List' })
    - waiting for" https://opensource-demo.orangehrmlive.com/web/index.php/pim/viewPersonalDetails/empNumber/262" navigation to finish...
    - navigated to "https://opensource-demo.orangehrmlive.com/web/index.php/pim/viewPersonalDetails/empNumber/262"
        ...
        - generic [ref=e178]:
          ...
          - generic [ref=e181]:
            - generic [ref=e185]:
              ...
              - generic [ref=e188]:
                - textbox "First Name" [ref=e191]: Fannie
                - textbox "Middle Name" [ref=e194]
                - textbox "Last Name" [ref=e197]: Gottlieb
            - separator [ref=e198]
            - generic [ref=e199]:
              - generic [ref=e200]:
                - generic [ref=e202]:
                  - generic [ref=e204]: Employee Id
                  - textbox [ref=e206]: "1428"
                - generic [ref=e208]:
...
```ts
  ...
  69 |     await expect(
  70 |       this.page.getByRole("heading", {
  71 |         name: "Employee List",
  72 |       }),
> 73 |     ).toBeVisible();
     |       ^ Error: expect(locator).toBeVisible() failed
  74 |   }
